...
# Get list of runtime classes
Get-ComRuntimeClass | Select Name, DllPath, ActivationType, TrustLevel | Out-GridView -Title "Runtime Classes"
# Get list of runtime extensions
Get-ComRuntimeExtension | Select ContractId, PackageId, AppId | Out-GridView -Title "Extensions"
Get-ComRuntimeExtension -Protocol | Select Protocol, PackageId, AppId | Sort Protocol | Out-GridView -Title "App Protocols"